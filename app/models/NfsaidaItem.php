...
class NfsaidaItem extends \Phalcon\Mvc\Model
{
    ...
    /**
     * Method to set the value of field cd_nfdsaida_item
     *
     * @param integer $cd_nfdsaida_item
     * @return $this
     */
    public function setCdNfdsaidaItem($cd_nfdsaida_item)
    {
        $this->cd_nfdsaida_item = $cd_nfdsaida_item;
    ...
    /**
     * Returns the value of field cd_nfdsaida_item
     *
     * @return integer
     */
