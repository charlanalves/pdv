...
class NovosFranqueados extends \Phalcon\Mvc\Model
{
    ...
    /**
     * Method to set the value of field idnovofranqueado
     *
     * @param integer $idnovofranqueado
     * @return $this
     */
    public function setIdnovofranqueado($idnovofranqueado)
    {
        $this->idnovofranqueado = $idnovofranqueado;
    ...
    /**
     * Returns the value of field idnovofranqueado
     *
     * @return integer
     */
    public function getIdnovofranqueado()
    {
        return $this->idnovofranqueado;
    }
    ...
    {
        return array(
            'idnovofranqueado' => 'idnovofranqueado',
            'nome' => 'nome',
            'cpf' => 'cpf',
            'endereco' => 'endereco',
            'numero' => 'numero',
